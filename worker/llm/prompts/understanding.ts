...
「ヒーロー」「主人公」という役割名だけはlabel_only。「友達以上と読むのはユーザーの解釈であり公式設定ではない」という出所の注記だけはattribution_onlyです。ユーザー解釈でも「ヒューズがロイの肩書きより本人を見て遠慮なく接する」のように具体的な関係を描写していれば、出所を区別してconcreteにできます。
