...
const definitions: RouteDefinition[] = [
  ...
  },
  {
    ...
    body: preferenceReviewRequestSchema,
    params: runParams,
    status: 202,
  },
  ...
  {
    method: "post",
    path: "/api/v1/dark/identity-candidates",
    summary: "Resolve dark-domain identity candidates",
    body: identityCandidateRequestSchema,
  },
  { method: "get", path: "/api/v1/dark/entries", summary: "List dark entries" },
  {
    method: "post",
    path: "/api/v1/dark/entries",
    summary: "Create dark entry",
    body: darkEntrySubmissionSchema,
    status: 202,
  },
  { method: "get", path: "/api/v1/dark/entries/{id}", summary: "Dark entry review detail", params: idParams },
  {
    method: "post",
    path: "/api/v1/dark/entries/{id}/reanalysis",
    summary: "Create dark entry revision and reanalysis",
    body: darkEntryReanalysisSchema,
    params: idParams,
    status: 202,
  },
  { method: "delete", path: "/api/v1/dark/entries/{id}", summary: "Archive dark entry", params: idParams, status: 204 },
  {
    method: "post",
    path: "/api/v1/dark/scope-assessments/{assessmentId}/review",
    summary: "Override or cancel an out-of-scope dark entry",
    body: darkScopeReviewRequestSchema,
    params: assessmentParams,
    status: 202,
  },
  {
    method: "post",
    path: "/api/v1/dark/understanding-snapshots/{snapshotId}/review",
    summary: "Review dark understanding snapshot",
    body: understandingReviewRequestSchema,
    params: snapshotParams,
    status: 202,
  },
  {
    method: "post",
    path: "/api/v1/dark/preference-analysis-runs/{runId}/review",
    summary: "Review dark preference analysis",
    body: preferenceReviewRequestSchema,
    params: runParams,
    status: 202,
  },
  { method: "get", path: "/api/v1/dark/profile", summary: "Dark profile and freshness" },
  { method: "get", path: "/api/v1/dark/profile/snapshot-items", summary: "Dark generation snapshot items" },
  { method: "get", path: "/api/v1/dark/profile/graph", summary: "Dark graph" },
  {
    method: "post",
    path: "/api/v1/dark/generation-requests",
    summary: "Create dark generation request",
    body: generationRequestInputSchema,
    status: 202,
  },
  { method: "get", path: "/api/v1/dark/generations", summary: "List dark generations" },
  {
    method: "delete",
    path: "/api/v1/dark/generations/{id}",
    summary: "Delete dark generation history",
    params: idParams,
    status: 204,
  },
  { method: "get", path: "/api/v1/dark/jobs/{id}", summary: "Dark job status", params: idParams },
  { method: "post", path: "/api/v1/dark/jobs/{id}/retry", summary: "Retry dark job", params: idParams, status: 202 },
  {
    method: "post",
